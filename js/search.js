...
// 刷新内容
    ...
    function search(require){
        ...
        for (var i of requireList.children){
            if(i.getAttribute("id")=="address" || i.getAttribute("id")=="key_word" ||i.getAttribute("id")=="house_style"){
        ...
        postData(url_search,require,function (res) {
            ...
            if(res["status_code"]==40005){
                all_room=[];
                house_list.innerHTML=`<div class="search_err">没有搜索到内容哦!</div>`;
    ...
    (function(){
        ...
        postData(url_search,require,function (res) {
            ...
            if(res["status_code"]==40005){
                all_room=[];
                house_list.innerHTML=`<h1 class="search_err">没有搜索到内容哦!</h1>`
                pagess(all_room);
            }else {
                all_room=res;
                console.log(all_room);
